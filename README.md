...
* [`TaskInformation`](src-java/com/ibm/cicsdev/restappext/TaskInformation.java) - provides a simple REST service for retrieving basic task
information.
...
* [`CICSInfoBean`](src-java/com/ibm/cicsdev/restappext/bean/CICSInfoBean.java) - simple JAX-RS bean for storing task information retrieved from CICS.
